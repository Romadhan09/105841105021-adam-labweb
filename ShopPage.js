...
class Home extends Component {
    render() {
        ...
        const newImages = [
            { source: require('./assets/foto1.png'), title: 'Evening Dress', subtitle: '10$' },
            { source: require('./assets/foto2.png'), title: 'Sport Dress', subtitle: '12$' },
            { source: require('./assets/foto3.png'), title: 'Sundress', subtitle: '15$' },
            { source: require('./assets/foto4.png'), title: 'Pkk', subtitle: '15$' },

            
        ];
        const twoimage = [
            { source: require('./assets/foto4.png'), title: 'Pkk', subtitle: '15$' },
            { source: require('./assets/foto2.png'), title: 'Pkk', subtitle: '15$' },
            { source: require('./assets/foto1.png'), title: 'Pkk', subtitle: '15$' },
            { source: require('./assets/foto3.png'), title: 'Pkk', subtitle: '15$' },
        ];
